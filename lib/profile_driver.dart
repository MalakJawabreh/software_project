...
class ProfileDriver extends StatefulWidget {
  ...
  const ProfileDriver({required this.username, required this.email,required this.completedTrips, Key? key})
      : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          SizedBox(height: 20),
          ListTile(
            leading: Icon(Icons.person, color:Color.fromARGB(230, 24, 83, 131), size: 31),
            title: Text(
              "Account",
              style: TextStyle(
          ...
          SizedBox(height: 15),
          ListTile(
            leading: Icon(Icons.attach_money, color:Color.fromARGB(230, 24, 83, 131), size: 31),
            title: Text(
              "Income Overview",
              style: TextStyle(
                fontSize: 23, // تحديد حجم الخط
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => IncomeOverview(completedTrips:widget.completedTrips),
                ),
              );
            },
          ),
          SizedBox(height: 15),
          ListTile(
            leading: Icon(Icons.lightbulb_circle_rounded, color:Color.fromARGB(230, 24, 83, 131), size: 31),
            title: Text(
              "Status",
              style: TextStyle(
                fontSize: 23, // تحديد حجم الخط
          ...
          SizedBox(height: 15),
          ListTile(
            leading: Icon(Icons.chat, color:Color.fromARGB(230, 24, 83, 131), size: 31),
            title: Text(
              "Chat settings",
              style: TextStyle(
                fontSize: 23, // تحديد حجم الخط
