...
class _AllUsersPageState extends State<AllUsersPage> {
  ...
  Future<void> fetchUsers() async {
    try {
      final response = await http.get(Uri.parse(all_users));
            ...
            if (user['role'] == 'Driver') ...[
              Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text(user['carNumber'] ?? 'Not provided', style: TextStyle(color: Colors.grey[700])),
                ],
              ),
              Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text(user['carType'] ?? 'Not provided', style: TextStyle(color: Colors.grey[700])),
                ],
              ),
            ],
